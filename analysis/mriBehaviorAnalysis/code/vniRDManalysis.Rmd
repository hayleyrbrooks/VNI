...
```{r}
model2_potc_amt = glmer(choice ~ 0 + pocRcvdMinusNotSC + (1|subjectIndex), data=mriBehClean, family="binomial", offset=pred);
...
model2_potc_amt_type_intxn = glmer(choice ~ 0 + poc1type*pocRcvdMinusNotSC + (1|subjectIndex), data=mriBehClean, family="binomial", offset=pred);
