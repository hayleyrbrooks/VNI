...
for (s in 1:nSubRaw) {
  ...
  for (r in 1:nRun){
    ...
    # LEFT OFF HERE - need to subset the EVG and modulation safe to only include the chosen vs unchosen options
    modulationChosen = RDMsub$choiceRecode[RDMsub$choiceRecode==1 & RDMsub$block==r]*modulationEVG-modulationSafe 
    modulationUnchosen = RDMsub$choiceRecode[RDMsub$choiceRecode==-1 & RDMsub$block==r]*modulationEVG-modulationSafe
