...
- outcomeDispEarnExpAmt_run#.txt: outcome display modulated by earnings - expectations (using beta weights from behavior; mean-centered across runs)
- outcomeDispLinear_run#.txt: outcome display modulated by a linear term (0 to 1 over the task; mean-centered across runs)
