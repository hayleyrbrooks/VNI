...
# For participants who did not miss any trials, we previously made will make 3-column zero timing files. We also made 3-column text files for participants who did miss trials but in the first column, we put 1 for missed trials. we aren't going to use those files for participants who did miss trials but they are still in the missedTrials folder on rdac (missedTrials_run1.txt for all participants). Eventually, we should probably organize those text files so that there is only the ones for runs for participants who missed trials.
