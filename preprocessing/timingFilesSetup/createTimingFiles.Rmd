...
- choiceDispShiftAmt_run#.txt: includes trials where shift occurred modulated by shift amount (mean centered, scaled)
...
#for (s in 1) {  
  ...
  #for (r in 1){
   ...
   # round and scale modulators
    ...
    meanShiftAmt = mean(RDMsubRun$positiveShiftSC[RDMsubRun$positiveShiftSC>0])  # calculate mean positive shift amount
    modulationShift = RDMsubRun$positiveShiftSC[RDMsubRun$positiveShiftSC>0] - meanShiftAmt # mean center the modulator
