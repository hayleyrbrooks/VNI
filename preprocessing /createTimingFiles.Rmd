...
timingFiles = list.files(timingFilePath, pattern= "*_event.csv", full.names = T); # store files from directory that we will need
...
mriBehRaw = mriBehRaw[-which(mriBehRaw$subjectIndex==13),];
